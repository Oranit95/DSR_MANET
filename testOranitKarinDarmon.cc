...
//  Config::SetDefault ("ns3::OnOffApplication::DataRate",  StringValue (rate));
  ...
  UdpServerHelper udpServerHelper(9);
  ApplicationContainer apps = udpServerHelper.Install(adhocNodes.Get(0));
  Ptr<UdpServer> udpServer = udpServerHelper.GetServer();
  UdpClientHelper udpClientHelper(Ipv4Address("10.0.0.1"), 9);
  udpClientHelper.SetAttribute("Interval", TimeValue(Seconds(7)));
  udpClientHelper.SetAttribute("MaxPackets", UintegerValue(100000000));


  apps.Add(udpClientHelper.Install(adhocNodes.Get(9)));
...
//
  ...
  //CheckThroughput ();
  AnimationInterface anim("oranitKarin.xml");
